...
import { Search, Settings, HelpCircle, LogIn, LogOut, User as UserIcon } from 'lucide-react';
  ...
  return (
    <div className="h-16 bg-bg-nav border-b border-[#262626] flex items-center justify-between px-8 text-sm shrink-0 w-full z-10">
      <div className="flex items-center gap-6 text-text-secondary">
        <button className="hover:text-text-primary transition-colors cursor-default">Docs</button>
        <button className="hover:text-text-primary transition-colors cursor-default">Benchmarks</button>
        <button className="hover:text-text-primary transition-colors cursor-default">Export</button>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 text-text-muted">
          <button className="hover:text-text-primary transition-colors"><Settings size={16} /></button>
          <button className="hover:text-text-primary transition-colors"><HelpCircle size={16} /></button>
        </div>
